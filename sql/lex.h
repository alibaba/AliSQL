...
static SYMBOL symbols[] = {
  ...
  { "COLUMNS",		SYM(COLUMNS)},
  { "COMFORT",		SYM(COMFORT_SYM)},
  { "COMMENT",		SYM(COMMENT_SYM)},
  { "COMMIT",		SYM(COMMIT_SYM)},
  { "COMMITTED",	SYM(COMMITTED_SYM)},
  { "COMMIT_ON_SUCCESS",SYM(CI_ON_SUCCESS_SYM)},
  ...
  { "QUERY",		SYM(QUERY_SYM)},
  { "QUEUE_ON_PK",      SYM(QUEUE_ON_PK_SYM)},
  { "QUICK",	        SYM(QUICK)},
  { "RANGE",            SYM(RANGE_SYM)},
  { "READ",		SYM(READ_SYM)},
  ...
  { "ROLLBACK_ON_FAIL", SYM(RB_ON_FAIL_SYM)},
  ...
  { "SQL_FILTERS",      SYM(SQL_FILTERS_SYM)},
  ...
  { "TARGET_AFFECT_ROW",SYM(TARGET_AFFECT_SYM)},
