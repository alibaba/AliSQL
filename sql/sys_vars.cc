...
static Sys_var_mybool Sys_force_innodb_to_duckdb(
...
static Sys_var_mybool Sys_force_innodb_to_duckdb_fallback(
    "force_innodb_to_duckdb_fallback",
    "If convert innodb to duckdb fails, fall back to duckdb.",
    GLOBAL_VAR(force_innodb_to_duckdb_fallback), CMD_LINE(OPT_ARG),
    DEFAULT(true), NO_MUTEX_GUARD, NOT_IN_BINLOG, ON_CHECK(0), ON_UPDATE(0));

static Sys_var_mybool Sys_duckdb_require_primary_key(
...
//TODODUCK: support insert only
my_bool duckdb_source_set_insert_only_to_binlog;
static Sys_var_mybool Sys_duckdb_set_insert_only_to_binlog(
...
static Sys_var_set Sys_duckdb_disabled_optimizers(
    ...
    SESSION_VAR(duckdb_disabled_optimizers),
...
static Sys_var_mybool Sys_duckdb_multi_trx_in_batch(
...
static Sys_var_mybool Sys_duckdb_convert_all_at_startup(
...
static Sys_var_mybool Sys_duckdb_convert_all_at_startup_ignore_error(
...
static Sys_var_mybool Sys_duckdb_convert_all_skip_mtr_db(
...
static Sys_var_mybool Sys_duckdb_force_no_collation(
...
static Sys_var_ulonglong Sys_duckdb_threads(
  ...
  VALID_RANGE(0, 1024 * 1024), DEFAULT(8), BLOCK_SIZE(1), NO_MUTEX_GUARD,
  NOT_IN_BINLOG, ON_CHECK(nullptr), ON_UPDATE(myduck::update_threads));

static Sys_var_mybool Sys_duckdb_use_direct_io(
...
static Sys_var_mybool Sys_duckdb_scheduler_process_partial(
...
static Sys_var_mybool Sys_duckdb_commit_multi_trx_due_to_reader(
...
static Sys_var_mybool Sys_duckdb_commit_multi_trx_due_to_rotate(
  "duckdb_commit_multi_trx_due_to_rotate",
  "Whether commit multiple transactions when apply a Rotate Event from "
  "Master.",
