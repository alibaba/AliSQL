...
*/
class PT_package_base : public Parse_tree_node {
 public:
  PT_package_base() {}
...
*/
class PT_package_proc : public PT_package_base {
 public:
  explicit PT_package_proc(List<Item> *opt_expr_list, const Proc *proc)
