...
#include "handler.h"
#include "sys_vars.h" // rds_inner_backup
#include "duckdb/duckdb_wrapper_c_api.h"
#include "binlog_ext.h"
#include "package/package_interface.h" // package_context_init
...
/** RDS DuckDB variables begin */
my_bool duckdb_convert_all_at_startup = FALSE;
my_bool duckdb_convert_all_at_startup_ignore_error = FALSE;
uint duckdb_convert_all_at_startup_threads = 0;
my_bool duckdb_convert_all_skip_mtr_db = FALSE;
my_bool opt_implicit_row_id_first = FALSE;
bool on_duckdb_convert_progress = false;
/** RDS DuckDB variables end */
...
SHOW_VAR com_status_vars[]= {
  ...
  {"native_admin_proc",    (char*) offsetof(STATUS_VAR, com_stat[(uint) SQLCOM_ADMIN_PROC]),                 SHOW_LONG_STATUS, SHOW_SCOPE_ALL},
...
#endif
{
...
#ifndef NDEBUG
  THD *duckdb_create_test_thd = new THD;
  duckdb_create_test_thd->bootstrap = true;
  duckdb_create_test_schema(duckdb_create_test_thd);
  delete duckdb_create_test_thd;
#endif
  ...
  */
  ...
  {
    create_duckdb_convertor_thread();
  }
...
#endif
  {"DuckDB_convert_stage_at_startup",(char *) &
  show_convert_stage,                            SHOW_FUNC,
  SHOW_SCOPE_GLOBAL},
  {"Com_duckdb_select",           (char*) offsetof(STATUS_VAR, com_duckdb_select),                                     SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
  {"Com_duckdb_insert", (char *)offsetof(STATUS_VAR, com_duckdb_insert),
    SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
  {"Com_duckdb_update", (char *)offsetof(STATUS_VAR, com_duckdb_update),
    SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
  {"Com_duckdb_delete", (char *)offsetof(STATUS_VAR, com_duckdb_delete),
    SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
  {"Com_duckdb_insert_select",
    (char *)offsetof(STATUS_VAR, com_duckdb_insert_select),
    SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
  {"Com_duckdb_explain", (char *)offsetof(STATUS_VAR, com_duckdb_explain),
    SHOW_LONGLONG_STATUS, SHOW_SCOPE_ALL},
  {NullS, NullS, SHOW_LONG, SHOW_SCOPE_ALL}
};
