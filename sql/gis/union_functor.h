...
/// used indirectly through the gis::union_() function.
///
/// @see gis::union_
...
class Union : public Functor<std::unique_ptr<Geometry>> {
 private:
 ...
 public:
  ...
  std::unique_ptr<Geometrycollection> eval(
  ...
  std::unique_ptr<Geometrycollection> eval(const Geographic_point *g1,
