#ifndef GIS__HAUSDORFF_DISTANCE_FUNCTOR_H_INCLUDED
#define GIS__HAUSDORFF_DISTANCE_FUNCTOR_H_INCLUDED
...
/// used indirectly through the gis::hausdorff_distance() function.
///
/// @see gis::hausdorff_distance
...
/// HausdorffDistance functor that calls Boost.Geometry with the
/// correct parameter types.
///
/// The functor throws exceptions and is therefore only intended used to
/// implement hausdorff_distance or other geographic functions.
/// It should not be used directly by other MySQL code.
class Hausdorff_distance : public Functor<double> {
 private:
...
#endif  // GIS__HAUSDORFF_DISTANCE_FUNCTOR_H_INCLUDED
