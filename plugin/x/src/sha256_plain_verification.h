...
#ifndef PLUGIN_X_SRC_SHA256_PLAIN_VERIFICATION_H_
#define PLUGIN_X_SRC_SHA256_PLAIN_VERIFICATION_H_
...
class Sha256_plain_verification : public iface::Account_verification {
 public:
...
#endif  // PLUGIN_X_SRC_SHA256_PLAIN_VERIFICATION_H_
