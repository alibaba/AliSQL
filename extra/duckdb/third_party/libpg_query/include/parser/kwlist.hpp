...
PG_KEYWORD("distinctrow", DISTINCTROW, RESERVED_KEYWORD)
PG_KEYWORD("div", DIV, RESERVED_KEYWORD)
...
PG_KEYWORD("mod", MOD, RESERVED_KEYWORD)
...
PG_KEYWORD("regexp", REGEXP, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("rlike", RLIKE, TYPE_FUNC_NAME_KEYWORD)
...
PG_KEYWORD("sql_big_result", SQL_BIG_RESULT, RESERVED_KEYWORD)
PG_KEYWORD("sql_buffer_result", SQL_BUFFER_RESULT, RESERVED_KEYWORD)
PG_KEYWORD("sql_cache", SQL_CACHE, RESERVED_KEYWORD)
PG_KEYWORD("sql_calc_found_rows", SQL_CALC_FOUND_ROWS, RESERVED_KEYWORD)
PG_KEYWORD("sql_no_cache", SQL_NO_CACHE, RESERVED_KEYWORD)
PG_KEYWORD("sql_small_result", SQL_SMALL_RESULT, RESERVED_KEYWORD)
...
PG_KEYWORD("timestampadd", TIMESTAMPADD, COL_NAME_KEYWORD)
...
PG_KEYWORD("use", USE_P, RESERVED_KEYWORD)
