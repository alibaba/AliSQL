...
BoundCastInfo DefaultCasts::DateCastSwitch(BindCastInput &input, const LogicalType &source, const LogicalType &target) {
	...
	case LogicalTypeId::DOUBLE:
		return BoundCastInfo(&VectorCastHelpers::TryCastLoop<date_t, double, duckdb::TryCast>);
	case LogicalTypeId::BIGINT:
		return BoundCastInfo(&VectorCastHelpers::TryCastLoop<date_t, int64_t, duckdb::TryCast>);
	default:
...
BoundCastInfo DefaultCasts::TimeCastSwitch(BindCastInput &input, const LogicalType &source, const LogicalType &target) {
	...
	case LogicalTypeId::DOUBLE:
		return BoundCastInfo(&VectorCastHelpers::TemplatedCastLoop<dtime_t, double, duckdb::Cast>);
	default:
		return TryVectorNullCast;
	}
}
...
BoundCastInfo DefaultCasts::TimestampCastSwitch(BindCastInput &input, const LogicalType &source,
	...
	case LogicalTypeId::DOUBLE:
		return BoundCastInfo(&VectorCastHelpers::TemplatedCastLoop<timestamp_t, double, duckdb::Cast>);
	default:
		return TryVectorNullCast;
	}
}
