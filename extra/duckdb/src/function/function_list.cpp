...
static const StaticFunctionDefinition function[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET(CharLengthFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(DateFormatFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(MidFun),
	DUCKDB_AGGREGATE_FUNCTION_SET(MinFun),
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(ModFun),
	DUCKDB_AGGREGATE_FUNCTION(MultiCountFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(RegexpReplaceDuckdbFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(StrToDateFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(TimeFormatFun),
