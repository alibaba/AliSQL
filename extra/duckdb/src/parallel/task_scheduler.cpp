...
int32_t TaskScheduler::NumberOfThreads(const ClientContext &context) {
	return MinValue<int32_t>(NumberOfThreads(), ClientConfig::GetConfig(context).max_threads_per_query);
}
