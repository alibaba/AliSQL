...
public:
	...
	void WriteTemporaryBuffer(MemoryTag tag, block_id_t block_id, FileBuffer &buffer, BlockHandle *block) override {
		return buffer_manager.WriteTemporaryBuffer(tag, block_id, buffer, block);
	}
