...
static const StaticFunctionDefinition core_functions[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET(AdddateFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(Base64Fun),
	...
	DUCKDB_SCALAR_FUNCTION_SET_ALIAS(CurrentTimestampFun),
	...
	DUCKDB_SCALAR_FUNCTION(FindInSetFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(GetCurrentTimestampFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(OctFun),
	DUCKDB_SCALAR_FUNCTION(OrdFun),
	...
	DUCKDB_AGGREGATE_FUNCTION_ALIAS(StdFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(SubdateFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(UnixTimestampFun),
	DUCKDB_SCALAR_FUNCTION(UnpivotListFun),
	DUCKDB_SCALAR_FUNCTION(UrlDecodeFun),
	DUCKDB_SCALAR_FUNCTION(UrlEncodeFun),
	DUCKDB_SCALAR_FUNCTION(UtcDateFun),
	DUCKDB_SCALAR_FUNCTION_SET(UtcTimeFun),
	DUCKDB_SCALAR_FUNCTION_SET(UtcTimestampFun),
