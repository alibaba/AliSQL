...
struct ICUStrftime : public ICUDateFunc {
	...
	static void AddCasts(ExtensionLoader &loader) {
		loader.RegisterCastFunction(LogicalType::TIMESTAMP_TZ, LogicalType::VARCHAR, BindCastToVarchar, 149);
	}
};
...
void RegisterICUStrptimeFunctions(ExtensionLoader &loader) {
	...
	ICUStrftime::AddBinaryTimestampFunction("date_format", loader);
	ICUStrftime::AddBinaryTimestampFunction("time_format", loader);
