...
#ifndef MYSQLROUTER_REST_SIGNAL_ABORT_INCLUDED
#define MYSQLROUTER_REST_SIGNAL_ABORT_INCLUDED
...
class RestSignalAbort : public RestApiHandler {
 public:
  static constexpr const char path_regex[] = "^/signal/abort$";
