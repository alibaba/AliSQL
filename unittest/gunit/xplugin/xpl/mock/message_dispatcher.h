...
#ifndef UNITTEST_GUNIT_XPLUGIN_XPL_MOCK_MESSAGE_DISPATCHER_H_
#define UNITTEST_GUNIT_XPLUGIN_XPL_MOCK_MESSAGE_DISPATCHER_H_
...
#endif  //  UNITTEST_GUNIT_XPLUGIN_XPL_MOCK_MESSAGE_DISPATCHER_H_
