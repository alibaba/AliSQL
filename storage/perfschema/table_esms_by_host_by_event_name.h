...
class PFS_index_esms_by_host_by_event_name : public PFS_engine_index {
 public:
  ...
  ~PFS_index_esms_by_host_by_event_name() override = default;
...
*/
struct pos_esms_by_host_by_event_name : public PFS_double_index {
  pos_esms_by_host_by_event_name() : PFS_double_index(0, 1) {}
...
class table_esms_by_host_by_event_name : public PFS_engine_table {
 ...
 public:
  ~table_esms_by_host_by_event_name() override = default;

 protected:
  int make_row(PFS_host *host, PFS_statement_class *klass);
 ...
 private:
  ...
  PFS_index_esms_by_host_by_event_name *m_opened_index;
};
