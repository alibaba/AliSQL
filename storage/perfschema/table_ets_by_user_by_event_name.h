...
class PFS_index_ets_by_user_by_event_name : public PFS_engine_index {
 public:
...
*/
struct pos_ets_by_user_by_event_name : public PFS_double_index {
  pos_ets_by_user_by_event_name() : PFS_double_index(0, 1) {}
...
class table_ets_by_user_by_event_name : public PFS_engine_table {
 ...
 private:
  ...
  PFS_index_ets_by_user_by_event_name *m_opened_index;
};
