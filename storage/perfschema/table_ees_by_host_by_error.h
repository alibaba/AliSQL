...
/**
  @file storage/perfschema/table_ees_by_host_by_error.h
...
class table_ees_by_host_by_error : public PFS_engine_table {
 ...
 private:
  ...
  /** Current position. */
  pos_ees_by_host_by_error m_pos;
  /** Next position. */
  pos_ees_by_host_by_error m_next_pos;

  PFS_index_ees_by_host_by_error *m_opened_index;
};
