...
class Record {
 private:
  ...
  Uint32 ncolumns, n_nullable, nblobs, index, rec_size, start_of_nullmap,
      size_of_nullmap;
...
inline const NdbRecord *Record::getNdbRecord() const { return ndb_record; }

inline Uint32 Record::getNoOfColumns() const { return ncolumns; }

inline Uint32 Record::getNoOfBlobColumns() const { return nblobs; }
...
inline Uint32 Record::getBufferSize() const { return rec_size; }
...
inline bool Record::partitionKey() const { return isPartitionKey; }

inline Uint32 Record::getPkColumnMask() const { return pkColumnMask.value; }

inline Uint32 Record::getAllColumnMask() const { return allColumnMask.value; }
