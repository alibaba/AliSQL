...
bool printCREATE_TRIG_IMPL_REQ(FILE *output, const Uint32 *theData, Uint32 len,
                               Uint16) {
...
bool printCREATE_TRIG_IMPL_CONF(FILE *output, const Uint32 *theData, Uint32 len,
                                Uint16) {
...
bool printCREATE_TRIG_IMPL_REF(FILE *output, const Uint32 *theData, Uint32 len,
                               Uint16) {
