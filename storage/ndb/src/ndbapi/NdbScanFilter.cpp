...
class NdbScanFilterImpl {
 public:
  ...
  int cond_col_col(Interpreter::BinaryCondition, Uint32 attrId1,
                   Uint32 attrId2);

  int cond_col_param(Interpreter::BinaryCondition, Uint32 attrId,
                     Uint32 paramId);
...
int NdbScanFilter::begin(Group group) {
  ...
  switch (group) {
    case NdbScanFilter::AND:
      ...
      if (m_impl.m_sql_cmp_semantics) {
        ...
        m_impl.m_code->set_sql_null_semantics(
            NdbInterpretedCode::BranchIfUnknown);
      }
      break;
    case NdbScanFilter::OR:
      ...
      if (m_impl.m_sql_cmp_semantics) {
        ...
        m_impl.m_code->set_sql_null_semantics(
            NdbInterpretedCode::ContinueIfUnknown);
      }
      break;
    default:
...
typedef int (NdbInterpretedCode::*Branch2Col)(Uint32 a1, Uint32 a2,
                                              Uint32 label);
typedef int (NdbInterpretedCode::*ParamBranch2)(Uint32 paramNo, Uint32 a1,
                                                Uint32 label);
...
int NdbScanFilterImpl::cond_col(Interpreter::UnaryCondition op, Uint32 AttrId) {
...
int NdbScanFilter::isnull(int AttrId) {
...
int NdbScanFilterImpl::cond_col_const(Interpreter::BinaryCondition op,
                                      Uint32 AttrId, const void *value,
                                      Uint32 len) {
  if (m_error.code != 0) return -1;
...
int NdbScanFilterImpl::cond_col_col(Interpreter::BinaryCondition op,
...
int NdbScanFilterImpl::cond_col_param(Interpreter::BinaryCondition op,
...
int NdbScanFilter::cmp_param(BinaryCondition cond, int ColId, int ParamId) {
  switch (cond) {
    case COND_LE:
...
int NdbScanFilter::cmp(BinaryCondition cond, int ColId1, int ColId2) {
  switch (cond) {
    case COND_LE:
...
const NdbError &NdbScanFilter::getNdbError() const {
...
const NdbInterpretedCode *NdbScanFilter::getInterpretedCode() const {
   ...
   */
  if (m_impl.m_associated_op != nullptr) return nullptr;
