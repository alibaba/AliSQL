...
struct NoOfFiredTriggers {
  ...
  static Uint32 getFiredCount(Uint32 v) { return v & ~(Uint32(DeferredBits)); }
  static Uint32 getDeferredUKBit(Uint32 v) {
    return (v & Uint32(DeferredUKBit)) != 0;
  }
  static void setDeferredUKBit(Uint32 &v) { v |= Uint32(DeferredUKBit); }
  static Uint32 getDeferredFKBit(Uint32 v) {
    return (v & Uint32(DeferredFKBit)) != 0;
  }
  static void setDeferredFKBit(Uint32 &v) { v |= Uint32(DeferredFKBit); }
