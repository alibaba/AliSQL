...
uint myisam_read_vec[] = {SEARCH_FIND,
                          SEARCH_FIND | SEARCH_BIGGER,
                          SEARCH_FIND | SEARCH_SMALLER,
                          SEARCH_NO_FIND | SEARCH_BIGGER,
                          SEARCH_NO_FIND | SEARCH_SMALLER,
                          SEARCH_FIND | SEARCH_PREFIX,
                          SEARCH_LAST,
...
uint myisam_readnext_vec[] = {SEARCH_BIGGER,  SEARCH_BIGGER,  SEARCH_SMALLER,
                              SEARCH_BIGGER,  SEARCH_SMALLER, SEARCH_BIGGER,
...
static PSI_memory_info all_myisam_memory[] = {
    ...
    {&mi_key_memory_MI_INFO_ft1_to_ft2, "MI_INFO::ft1_to_ft2", 0, 0,
     PSI_DOCUMENT_ME},
    {&mi_key_memory_MI_INFO_bulk_insert, "MI_INFO::bulk_insert", 0, 0,
     PSI_DOCUMENT_ME},
    ...
    {&mi_key_memory_MI_SORT_PARAM_wordroot, "MI_SORT_PARAM::wordroot", 0, 0,
     PSI_DOCUMENT_ME},
    ...
    {&mi_key_memory_SORT_INFO_buffer, "SORT_INFO::buffer", 0, 0,
     PSI_DOCUMENT_ME},
    {&mi_key_memory_MI_DECODE_TREE, "MI_DECODE_TREE", 0, 0, PSI_DOCUMENT_ME},
    {&mi_key_memory_MYISAM_SHARE_decode_tables, "MYISAM_SHARE::decode_tables",
     0, 0, PSI_DOCUMENT_ME},
    {&mi_key_memory_preload_buffer, "preload_buffer", 0, 0, PSI_DOCUMENT_ME},
    {&mi_key_memory_stPageList_pages, "stPageList::pages", 0, 0,
     PSI_DOCUMENT_ME},
    {&mi_key_memory_keycache_thread_var, "keycache_thread_var", 0, 0,
     PSI_DOCUMENT_ME},
